...
import { Hex, concat, createClient, http, decodeErrorResult } from "viem";
import { OPEN_LOOT_CHAIN, OPEN_LOO_RPC_URL } from "./openfort-simple/chainConstatnts";
import { createCaliburAccount } from "./../../drafts/simple-calibur-v9/calibur-simple";
import { PAYMASTER_ADDRESS_V9_ASYNC, MODE, VALID_UNTIL, VALID_AFTER, DUMMY_PAYMASTER_SIGNATURE, VERIFYING_MODE } from "./openfort-simple/paymasterConstants";
import { createBundlerClient, type UserOperation, formatUserOperationRequest, formatUserOperationGas, toPackedUserOperation } from "viem/account-abstraction";
...
const BUNDLER_API_URL = "https://api.openfort.io/rpc/510531";
...
const accountPackedSignature = await account.signUserOperation(userOp);
