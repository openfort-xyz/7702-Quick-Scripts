...
import { KeyType, DUMMY_SIGNATURES } from "@/data/accountConstants";
...
export type P256Signature = {
    ...
    s: Hex;
    pubKey: PubKey;
    keyType: KeyType.P256 | KeyType.P256_NONKEY;
};
...
export const encodeEOASignature = (signature: Hex): Hex =>
    encodeAbiParameters(OUTER_WRAP_ABI, [BigInt(KeyType.EOA), signature]);
...
export const getStubEOASignature = (): Hex =>
    encodeAbiParameters(STUB_SIGNATURE_ABI, [BigInt(KeyType.EOA), DUMMY_SIGNATURES[KeyType.EOA]]);

export const getStubWebAuthnSignature = (): Hex => DUMMY_SIGNATURES[KeyType.WEBAUTHN];

export const getStubP256Signature = (): Hex => DUMMY_SIGNATURES[KeyType.P256];

export const getStubP256NonKeySignature = (): Hex => DUMMY_SIGNATURES[KeyType.P256_NONKEY];